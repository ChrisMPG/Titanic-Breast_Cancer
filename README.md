This is a school project where the main focus was to do a Descriptive and Exploratory analysis using the titanic.csv dataset and perform a PCA Analysis using the breast_cancer.csv 
